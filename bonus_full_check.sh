...
if [ "$(echo -en "ra\npb\npb\nrb\nsa\nrra\npa\npa\nrra\nrra\n" | ./checker 5 4 3 2 1)" = "OK" ]; then
    echo -e "\033[32mOK\033[0m : unsorted list with valid input"
else 
    echo -e "\033[31mKO\033[0m : unsorted list with valid input expected: OK"
fi

if [ "$(echo -en "pb\nra\nsa\npa\n" | ./checker 2 1)" = "KO" ]; then
    echo -e "\033[32mOK\033[0m : unsorted list with invalid input"
else
    echo -e "\033[31mKO\033[0m : Expected: KO"
fi
...
if [ "$(echo -en "ra\n" | ./checker 3 1 2)" = "OK" ]; then
    ...
    echo -e "\033[31mKO\033[0m : Expected: OK"
fi
